ACCOUNT_MAPPINGS = {
    ...
    'marrowng': [
        'metapool', 'marketing', 'founder', 'community', 'latam', 'español',
    ...
    'EsNearEs': [
        'español', 'latam', 'noticias', 'news', 'community', 'EsNearEs',
    ...
    'Near_Colombia': [
        'latam', 'nation', 'español', 'colombia', 'news', 'community',
    ...
    'NearFrancais': [
        ...
        'NEAR Français', 'blockchain', 'NEAR', 'France', 'French language',
